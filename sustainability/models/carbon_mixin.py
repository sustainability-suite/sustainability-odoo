...
class CarbonMixin(models.AbstractModel):
    ...
    def _get_uom_filtered_factors_domain(self, uom_field=None):
        """Filter physical EF on product uom & weight + include monetary ones. Argument uom_field should be str value."""
        uom_id = False
        if uom_field and (
