from odoo.addons.onsp_co2.tests.common import CarbonCommon
...
class TestCarbonUom(CarbonCommon):
    ...
    def test_10_uom(self):
        ...
        self.assertEqual(round(invoice_out.carbon_balance, 1), 20.0, "Converted quantity for customer invoice does not correspond.")
        ...
        self.assertEqual(round(invoice_in.carbon_balance, 1), 12.0, "Converted quantity for vendor bill does not correspond.")
    ...
    def test_20_currency(self):
        ...
        self.assertEqual(round(invoice_out.carbon_balance, 0), 190.0, "Converted quantity for customer invoice does not correspond.")
