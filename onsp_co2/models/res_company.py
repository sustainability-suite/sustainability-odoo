...
class ResCompany(models.Model):
    ...
    # Idea: add an archived factor for company, might be useful. (or not)
    carbon_value = fields.Float(compute=False, store=True, readonly=False)
    carbon_sale_value = fields.Float(compute=False, store=True, readonly=False)
